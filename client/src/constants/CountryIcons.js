...
import netherlandsIcon from 'assets/panel/countries/netherlands_icon.png'
import australiaIcon from 'assets/panel/countries/australia_icon.png'
import saudiIcon from 'assets/panel/countries/saudi_icon.png'
import newZelandIcon from 'assets/panel/countries/new_zeland_icon.png'
import peruIcon from 'assets/panel/countries/peru_icon.png'
...
export const CountryIcons = {
  ...
  "ЕГИПЕТ": egyptIcon,
  "ИЗРАИЛЬ": izrailIcon,
  "НИДЕРЛАНДЫ": netherlandsIcon,
  "АВСТРАЛИЯ": australiaIcon,
  "САУДОВСКАЯ АРАВИЯ": saudiIcon,
  "НОВАЯ ЗЕЛАНДИЯ": newZelandIcon,
  "ПЕРУ": peruIcon,
  "МЕКСИКА": mexicanIcon,
  "ЧИЛИ": chileIcon,
  "КАНАДА": canadaIcon,
